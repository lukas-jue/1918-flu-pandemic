...
The current Covid-19 pandemic comes with extreme medical and economic consequences.
Sickened by the SARS-CoV-2 virus, patients worldwide die, while in-person businesses are shut down for significant times.
Since almost all living generations did not witness a similar health and economic emergency, it might be thought of as \textit{unprecedented}.
...
While this exercise might be interesting in itself, this paper secondly evaluates to which degree those findings could be transferred to the current crisis.
...
In mainly three waves in the northern hemisphere's spring 1918, fall 1918, and winter/spring 1918/19, the virus infected approximately 500 million people, roughly one third of the entire world population at that time \citep{taubenberger1918InfluenzaMother2006}.
...
Center to this debate is the apparent trade-off policy-makers face: NPIs result in closed businesses and less immediate economic activity, but also possibly in a less severe course of the disease, fewer deaths, and hence a quicker recovery.
...
at least the US economy did not suffer to the expected degree in the short term.
...
The top 1\% US earners' income as a percentage of total income in 1919 increased by 2\%-points compared to the previous year, while decreasing to the earlier level of approximately 18\% in the following two years.
